...
- usuario natural: este usuario hace un tipo de compra al detal, por lo tanto, navega en la web en busca de descuentos por temporada. Desea encontrar una promoción acorde a su presupuesto, pero resulta que para este producto, no es tan común encontrar ofertas (incluso en alta demanda).

- usuario emprendedor: este usuario hace un tipo de compra al por mayor, para distribuir y generar ingresos; desea encontrar una oferta que le ayude aumentar su margen de ganancias.
